        ...
        <q-card class="my-card q-pt-sm q-ml-md q-mr-md q-mb-lg" v-for="item in projectList" :key="item.seq">
          ...
          <q-item>
            <q-item-section avatar>
              ...
              <div v-else>
                <q-icon name="rocket" size="md" color="black" />
              </div>
            </q-item-section>
            <q-item-section>
              <div class="row">
          ...
          <q-card-actions align="around">
            ...
            <q-btn flat style="width: 23%;" @click="createContract(item)" no-caps>
              <table border="0" cellpadding="0" sellspacing="0" width="100%">
                ...
                <tr>
                  <td><span class="text-black">{{ $t('contract') }}</span></td>
                </tr>
              </table>
            </q-btn>
          </q-card-actions>
            ...
            <q-card-actions>
              <q-btn flat style="width: 100%;" @click="goRegisterVote(item)" no-caps>
                <table border="0" cellpadding="0" sellspacing="0" width="100%">
                  ...
                  <tr>
                    <td><span class="text-black">{{ $t('project_register_withdrawal_request_vote') }}</span></td>
                  </tr>
                </table>
              </q-btn>
            </q-card-actions>
