        ...
        <q-card class="my-card q-pt-sm q-ml-md q-mr-md q-mb-lg" v-for="item in voteList" :key="item.seq">
          ...
          <q-item>
            <q-item-section avatar>
              <div v-if="item.logo_image">
                <img :src="item.logo_image" style="width: 100%; max-width: 50px" />
              </div>
              <div v-else>
                <q-icon name="how_to_vote" size="md" color="black" />
              </div>
            </q-item-section>
            <q-item-section>
              <div class="row">
                <q-item-label class="col-12 text-weight-bold">{{ $t('vote_seq') }} [ {{ item.seq }} ]</q-item-label>
          ...
          <q-card-actions align="around">
            ...
            <q-btn flat style="width: 23%;" @click="goDetail(item.seq)" no-caps>
              <table border="0" cellpadding="0" sellspacing="0" width="100%">
                ...
                <tr>
                  <td><span class="text-black">{{ $t('detail') }}</span></td>
                </tr>
              </table>
            </q-btn>
            <!-- fix -->
            <q-btn v-if="item.status_cd < '30'" flat style="width: 23%;" @click="fixVote(item)" no-caps>
              <table border="0" cellpadding="0" sellspacing="0" width="100%">
                ...
                <tr>
                  <td><span class="text-black">{{ $t('fix') }}</span></td>
                </tr>
              </table>
            </q-btn>
            <!-- close off vote -->
            ...
            <q-btn v-if="item.status_cd === '30'" flat style="width: 23%;" @click="closeOffVote(item)">
              <table border="0" cellpadding="0" sellspacing="0" width="100%">
                ...
                <tr>
                  <td><span class="text-black text-lowercase">{{ $t('close_off') }}</span></td>
                </tr>
              </table>
            </q-btn>
            <!-- withdraw -->
