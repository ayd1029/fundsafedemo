<template>
  ...
  <q-page class="justify justify-center">
    <div class="page-default" style="word-break: keep-all;">
      ...
      <div class="text-center text-body q-pl-md q-pr-md" style="word-break: keep-all;">
        ...
        <div class="text-h5 text-bold q-pt-md">
          <div v-if="locale === 'en-US'">
            [ Anti-Rug Pull Solution ]
          </div>
          <div v-else-if="locale === 'ko-KR'">
            [ 안전한 블록체인 프로젝트 자금 관리 솔루션 ]
          </div>
          <br />
          <br />
        </div>
        ...
        <q-img v-if="locale === 'en-US'" src="images/fundsafe_bm_en.png" style="max-width: 1024px;" />
        <q-img v-else-if="locale === 'ko-KR'" src="images/fundsafe_bm_ko.png" style="max-width: 1024px;" />
        <br />
        <br />
        <q-separator />
        ...
        <div v-if="locale === 'en-US'">
          ...
          <br />
          <br />
          <br /><img src="logo/logo_fundsafe_mark.png" style="max-width: 150px; cursor: pointer;" @click="goProjectDetail" />
          <br />
      ...
      <!-- <div class="text-center text-body q-pl-md q-pr-md" style="word-break: keep-all;">
        <q-img src="logo/logo_fundsafe_mark.png" style="max-width: 150px;" />
      </div> -->
